...
| `BtshopFinalCta`                | `src/components/organisms/BtshopFinalCta.tsx`                | btshop.hu high-ticket CTA - egyedi árajánlat kérés nagyvállalati rendszerekre, cyan glow, spring hover                                                                                                                                                                                     | `"use client"` (motion/react)          |
