...
async function processAIWorkflow(_data) {
...
exports.processGenerationQueue = (0, firestore_1.onDocumentCreated)("user_generations/{docId}", async (event) => {
    ...
    console.log(`Processing generation ${docId} for user ${data === null || data === void 0 ? void 0 : data.userId}`);
