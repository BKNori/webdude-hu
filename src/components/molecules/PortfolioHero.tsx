  ...
  return (
    ...
    >
      ...
      <div className="text-center space-y-8 px-6">
        ...
        >
          Eredmények, nem csak{" "}
          <span className="text-transparent bg-clip-text bg-linear-to-r from-[#00B5F1] to-[#FF7A00] italic pr-4">
            Dizájn
          </span>
        </motion.h1>
        ...
        <motion.a
          ...
          whileTap={{ scale: 0.95 }}
          href="/kapcsolat"
          className="inline-block px-10 py-5 bg-[#00B5F1] hover:bg-[#0095C7] text-white rounded-full font-bold text-lg shadow-[0_8px_24px_rgba(0,181,241,0.2)] hover:shadow-[0_18px_40px_rgba(0,181,241,0.3)] transition-all duration-300"
        >
          Kapcsolat →
        </motion.a>
      </div>
