    ...
    <section className="relative py-28 px-6 overflow-hidden">
      ...
      >
        ...
        >
          <Link
            href="/kapcsolat"
            className="group inline-flex items-center gap-3 px-10 py-5 rounded-full font-bold text-white bg-linear-to-r from-[#00B5F1] to-[#0095C7] hover:from-[#0095C7] hover:to-[#007BA8] shadow-[0_8px_32px_rgba(0,181,241,0.35)] hover:shadow-[0_16px_48px_rgba(0,181,241,0.45)] transition-all"
          >
