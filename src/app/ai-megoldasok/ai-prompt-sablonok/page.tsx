...
const promptTemplates = [
  ...
  },
  {
    ...
    icon: ImageIcon,
    color: "from-orange-500 to-[#00B5F1]",
        ...
        <div className="max-w-md w-full px-6">
          ...
          >
            ...
            <div className="space-y-3">
              <Link
                href="/bejelentkezes"
                className="block w-full py-3 bg-[#00B5F1] text-bg-base font-bold rounded-xl hover:bg-[#00B5F1]/400 transition-all"
              >
                Bejelentkezés
              </Link>
              <Link
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <Link
                ...
                className="inline-flex items-center gap-2 px-8 py-4 bg-[#00B5F1] text-bg-base font-bold rounded-xl hover:bg-[#00B5F1]/400 transition-all shadow-lg shadow-[#00B5F1]/20"
              >
                  ...
                  <div className="p-6 bg-bg-surface/30">
                    ...
                    <div className="relative">
                      ...
                      <button
                        ...
                        className="absolute top-2 right-2 p-2 rounded-lg bg-bg-card border border-bg-elevated/40 hover:bg-[#00B5F1] hover:text-bg-base hover:border-[#00B5F1] transition-all"
                      >
