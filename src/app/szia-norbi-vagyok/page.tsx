    ...
    <main className="min-h-screen bg-bg-base text-text-primary">
      ...
      <section className="relative min-h-screen flex items-center justify-center pt-32 pb-40 overflow-hidden">
        ...
        <div className="absolute inset-0 z-0 overflow-hidden">
          <div className="absolute top-20 right-20 w-96 h-96 bg-linear-to-br from-sky-400/20 to-blue-500/20 rounded-full blur-[120px] animate-pulse" />
          ...
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-150 h-150 bg-linear-to-br from-blue-300/10 to-sky-300/10 rounded-full blur-[150px]" />
        </div>
        ...
        <div className="max-w-6xl mx-auto px-6 relative z-10 grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="inline-block relative pl-6">
              ...
              <div className="absolute left-0 top-0 w-1 h-6 bg-linear-to-b from-[#00B5F1] to-[#5B21B6] rounded-full" />
            </div>
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          >
            ...
            <h2 className="text-4xl sm:text-5xl md:text-7xl font-bold font-sans text-text-primary leading-tight tracking-tight">
              A Te{" "}
              <span className="italic text-transparent bg-clip-text bg-linear-to-r from-[#00B5F1] to-[#5B21B6]">
                Digitális Partnered.
              </span>
            </h2>
          ...
          <div className="grid md:grid-cols-3 gap-8 mt-20">
            {[
              ...
              >
                <span className="text-6xl font-black font-serif block mb-4 text-text-primary group-hover:text-transparent group-hover:bg-clip-text group-hover:bg-linear-to-r group-hover:from-[#00B5F1] group-hover:to-[#5B21B6] transition-all">
                  {stat.value}
                </span>
      ...
      <section className="py-32 bg-linear-to-br from-bg-surface to-bg-elevated relative overflow-hidden">
        <div className="absolute top-0 right-0 w-125 h-125 bg-linear-to-br from-[#00B5F1]/10 to-[#5B21B6]/10 rounded-full blur-[100px] pointer-events-none animate-pulse" />
            ...
            {processSteps.map((step, idx) => (
              ...
              >
                ...
                <div className="relative z-10">
                  <span className="w-8 h-8 rounded-full bg-transparent border border-slate-700 text-text-primary flex items-center justify-center text-sm font-bold mb-6 group-hover:bg-linear-to-r group-hover:from-[#00B5F1] group-hover:to-[#5B21B6] group-hover:text-slate-950 group-hover:border-transparent transition-all">
                    {step.icon}
                  </span>
                  <h4 className="text-lg font-black font-outfit mb-3 text-text-primary group-hover:text-transparent group-hover:bg-clip-text group-hover:bg-linear-to-r group-hover:from-[#00B5F1] group-hover:to-[#5B21B6] transition-all">
                    {step.title}
                  </h4>
      ...
      <section className="py-40 bg-linear-to-br from-bg-surface to-bg-elevated text-text-primary text-center relative overflow-hidden border-t border-slate-800">
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-linear-to-br from-[#00B5F1]/10 to-[#5B21B6]/10 rounded-full blur-[100px] pointer-events-none animate-pulse" />
        <div className="max-w-6xl mx-auto px-6 relative z-10">
          <motion.div
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
