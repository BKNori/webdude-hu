        ...
        <section className="relative py-24 overflow-hidden">
          ...
          <div className="max-w-6xl mx-auto px-6 relative z-10">
            <div className="text-center space-y-6">
              ...
              >
                UI/UX tervezés AI eszközökkel. Felhasználói élmény optimalizálás
                és vizuális tervezés. 4.1x UX konverzió, 73% design idő
                megtakarítás, Figma kompatibilis outputok.
              </motion.p>
            </div>
          </div>
        </section>
