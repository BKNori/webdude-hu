          ...
          <div className="max-w-6xl mx-auto px-6 relative z-10">
            <div className="text-center space-y-6">
              ...
              >
                ...
                szezonális vizuálok generálása Midjourney v6 Master promptokkal.
                4.2x szezonális konverzió, 78% kampány idő megtakarítás, 4K
                felbontású outputok.
              </motion.p>
            </div>
          </div>
            ...
            >
              <div className="flex items-center gap-3 mb-8">
                <div className="w-12 h-12 rounded-xl bg-linear-to-br from-[#00B5F1]/10 to-[#FF7A00]/10 border border-[#00B5F1]/20 flex items-center justify-center">
                  <Calendar className="w-6 h-6 text-[#00B5F1]" />
                </div>
                <div>
