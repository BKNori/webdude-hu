...
const productSchema = {
  ...
  description:
    "Az exkluzív 6-ágensű multi-agent AI workflow rendszer. Kristófka: 26 éves grafikai rutin + 16 év webfejlesztői tapasztalat találkozik a legújabb AI technológiákkal.",
...
export default function KristofkaMunkafolyamatPage() {
  return (
    <>
      <script
      ...
      <ProductAccessGuard>
        <div className="min-h-screen bg-[#020617]">
            ...
            <div className="max-w-6xl mx-auto px-6 relative z-10">
              <div className="text-center space-y-6">
                ...
                <p className="text-lg text-slate-400 max-w-2xl mx-auto leading-relaxed">
                  Ingatlanbefektetői pitch generálás PDF alaprajzokból és
                  kontextus paraméterekből. Strategist-Pro szintű AI workflow.
                  4.8x befektetői konverzió, 72% pitch idő megtakarítás, 500M+
                  Ft befektetés generáció.
                </p>
              </div>
            </div>
          </section>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="bg-slate-950/80 border border-slate-800/80 rounded-3xl p-6 shadow-[0_8px_24px_rgba(0,0,0,0.35)] hover:shadow-[0_16px_48px_rgba(245,158,11,0.18)] transition-all duration-300">
                  ...
                  <p className="text-sm text-slate-400">
                    AI-optimalizált pitch generálás alapvető befektetői
                    meggyőzés
                  </p>
                </div>
                <div className="bg-slate-950/80 border border-slate-800/80 rounded-3xl p-6 shadow-[0_8px_24px_rgba(0,0,0,0.35)] hover:shadow-[0_16px_48px_rgba(245,158,11,0.18)] transition-all duration-300">
                  ...
                  <p className="text-sm text-slate-400">
                    PDF alaprajz elemzés és automatikus pitch generálás
                  </p>
                </div>
                <div className="bg-slate-950/80 border border-slate-800/80 rounded-3xl p-6 shadow-[0_8px_24px_rgba(0,0,0,0.35)] hover:shadow-[0_16px_48px_rgba(245,158,11,0.18)] transition-all duration-300">
                  <h3 className="text-lg font-bold text-[#e2e8f0] mb-2">
                  ...
                  <p className="text-sm text-slate-400">
                    Strategist-Pro szintű AI workflow befektetői pitch
                    optimalizálás
                  </p>
                </div>
                <div className="bg-slate-950/80 border border-slate-800/80 rounded-3xl p-6 shadow-[0_8px_24px_rgba(0,0,0,0.35)] hover:shadow-[0_16px_48px_rgba(245,158,11,0.18)] transition-all duration-300">
                  ...
                  <p className="text-sm text-slate-400">
                    Személyre szabott befektetői pitch testreszabás
                  </p>
                </div>
              </div>
            </div>
          ...
          <section className="py-16 md:py-24 border-t border-slate-800/80">
            <div className="max-w-4xl mx-auto px-6 text-center">
              ...
              <p className="text-slate-400 mb-8">
                Azonnali hozzáférés a Kristófka Munkafolyamat AI workflow-hoz.
              </p>
          ...
          <ProductPortalCta productName="Kristófka Munkafolyamat" />
        </div>
      </ProductAccessGuard>
    </>
  );
