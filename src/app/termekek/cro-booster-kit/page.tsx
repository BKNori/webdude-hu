...
const productSchema = {
  ...
  description:
    "Konverzió optimalizáló eszközök és sablonok. Növeld a konverziós rátádat 2.5x-re A/B teszteléssel, heatmap analitikával és konverzió-optimalizált landing page sablonokkal.",
    ...
    <>
      ...
      <ProductAccessGuard>
        <div className="min-h-screen bg-[#020617]">
            ...
            <div className="max-w-6xl mx-auto px-6 relative z-10">
              <div className="text-center space-y-6">
                ...
                <p className="text-lg text-slate-400 max-w-2xl mx-auto leading-relaxed">
                  ...
                  heatmap elemzés és user journey optimalizáció kész
                  eszközökkel. 2.8x hirdetési ROI, 45% bounce rate csökkenés.
                </p>
              </div>
            </div>
          </section>
          ...
          <ProductPortalCta productName="CRO Booster Kit" />
        </div>
      </ProductAccessGuard>
    </>
  );
