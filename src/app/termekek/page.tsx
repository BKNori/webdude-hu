  ...
  if (!user || !isAdmin) {
    return (
      <div className="min-h-screen bg-bg-base flex flex-col items-center justify-center space-y-6 px-6">
        ...
        <Link
          href="/admin/login"
          className="px-6 py-3 rounded-xl bg-[#00B5F1] text-white font-bold hover:bg-[#00B5F1]/400 transition-colors"
        >
          Bejelentkezés
        </Link>
      </div>
    ...
    <div className="min-h-screen bg-transparent">
            ...
            {products.map((product, index) => {
              ...
              return (
                <motion.div
                  ...
                  className="group bg-slate-900/80 backdrop-blur-md border border-slate-700 rounded-2xl overflow-hidden hover:border-[#00B5F1]/50 transition-all duration-300 shadow-[0_8px_24px_rgba(15,23,42,0.3)] hover:shadow-[0_18px_40px_rgba(245,158,11,0.2)] hover:-translate-y-1"
                >
                  <div className="p-6">
                    {/* Header */}
                    <div className="flex items-start justify-between mb-4">
                      <div className="w-14 h-14 rounded-xl bg-linear-to-br from-[#00B5F1]/10 to-[#0095C7]/10 border border-[#00B5F1]/20 flex items-center justify-center group-hover:border-[#00B5F1]/50 transition-colors">
                    ...
                    <Link
                      href="/kapcsolat"
                      className="flex items-center justify-center gap-2 w-full py-3 bg-linear-to-r from-[#00B5F1] to-[#0095C7] text-white font-bold rounded-xl hover:shadow-[0_8px_24px_rgba(245,158,11,0.3)] transition-all group-hover:scale-[1.02]"
                    >
      ...
      <section className="py-16 border-t border-slate-800 bg-bg-surface">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <Link
            href="/kapcsolat"
            className="inline-flex items-center gap-2 px-8 py-4 bg-linear-to-r from-[#00B5F1] to-[#0095C7] text-white font-bold rounded-xl hover:shadow-[0_8px_24px_rgba(245,158,11,0.3)] transition-all"
          >
            Kapcsolatfelvétel
            <ArrowRight className="w-4 h-4" />
          </Link>
