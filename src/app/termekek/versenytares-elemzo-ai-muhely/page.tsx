          ...
          <div className="max-w-6xl mx-auto px-6 relative z-10">
            <div className="text-center space-y-6">
              ...
              >
                ...
                elemzés és versenytárs stratégia kialakítás. 3.9x versenyelő
                előny, 67% piac elemzés idő megtakarítás, stratégiai insightok.
              </motion.p>
            </div>
          </div>
        </section>
            ...
            >
              <div className="flex items-center gap-3 mb-8">
                <div className="w-12 h-12 rounded-xl bg-linear-to-br from-[#00B5F1]/10 to-[#FF7A00]/10 border border-[#00B5F1]/20 flex items-center justify-center">
                  <Users className="w-6 h-6 text-[#00B5F1]" />
                </div>
                <div>
